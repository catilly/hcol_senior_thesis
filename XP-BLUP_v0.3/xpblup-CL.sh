...
# Slightly modified in 3/2018 by Catherine Li:
# Included a prefix for the grmList and train_.pheno files to prevent problems when parallelizing.
...
if [ -z "$pheno_" ]; then
	pheno_=${outdir}/${outprefix}_train_.pheno; 
...
# REML
grmlist=${out_prefix}_grmList.txt
> ${grmlist}
